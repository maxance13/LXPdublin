...
<head>
    ...
    $mysqlConnection = new PDO(
        'mysql:host=localhost;dbname=fithome;charset=utf8','root','root'
    );
    ?>
...
<body>
    ...
    <main class="mainHome">
        <p class="Home_Rep">> <a href="index.php" class="Home_Rep1"> Home</a> > <a href="coach.php" class="Home_Rep1"> Coach</a></p>
